/*
 * Slim v4.5.3 - Image Cropping Made Easy
...
! function(t, e) {
    ...
    if (t)
        if (t.Slim = function() {
                ...
                function i(t, e) {
                    if (!(e >= 1)) {
                        for (var i = t.width * e, n = t.height * e, o = t.width, a = t.height, r = t; o > i && a > n;) {
                            var s = document.createElement("canvas");
                            o = .5 * r.width, a = .5 * r.height, o < i && (o = i), a < n && (a = n), s.width = o, s.height = a;
                            var h = s.getContext("2d");
                            h.drawImage(r, 0, 0, o, a), r = rt(s)
                        }
                        t.width = i, t.height = n;
                        var h = t.getContext("2d");
                        h.drawImage(r, 0, 0, i, n)
                    }
                }! function() {
                    function t(t, i) {
                        i = i || {
                ...
                n.isInstanceOf = function(t, e) {
                    ...
                    i = i || {};
                    var r, s, h, u, l, c, p, d, f, _, m, g = document.createElement("canvas"),
                        ...
                        if (65496 === c.getUint16(0)) {
                            for (; p < d && (a = c.getUint16(p), a >= 65504 && a <= 65519 || 65534 === a) && (s = c.getUint16(p + 2) + 2, !(p + s > c.byteLength));) {
                                if (h = n.metaDataParsers.jpeg[a])
                                    for (u = 0; u < h.length; u += 1) h[u].call(o, c, p, s, r, i);
                                p += s, f = p
                ...
                var u = function() {
                    ...
                    l = function() {
                        ...
                        function i(t, e, i, r, s, h) {
                            var u, l, c, p, d, f, _, m, g, v, y, w, b, k, x, S, E, C, P, T, I, O, R, M, L = t.data,
                                D = h + h + 1,
                                z = r - 1,
                                A = s - 1,
                                B = h + 1,
                            ...
                            var q = o[h],
                                V = a[h];
                            for (l = 0; l < s; l++) {
                                for (S = E = C = P = m = g = v = y = 0, w = B * (T = L[f]), b = B * (I = L[f + 1]), k = B * (O = L[f + 2]), x = B * (R = L[f + 3]), m += U * T, g += U * I, v += U * O, y += U * R, H = N, c = 0; c < B; c++) H.r = T, H.g = I, H.b = O, H.a = R, H = H.next;
                                for (c = 1; c < B; c++) p = f + ((z < c ? z : c) << 2), m += (H.r = T = L[p]) * (M = B - c), g += (H.g = I = L[p + 1]) * M, v += (H.b = O = L[p + 2]) * M, y += (H.a = R = L[p + 3]) * M, S += T, E += I, C += O, P += R, H = H.next;
                                for (W = N, j = F, u = 0; u < r; u++) L[f + 3] = R = y * q >> V, 0 != R ? (R = 255 / R, L[f] = (m * q >> V) * R, L[f + 1] = (g * q >> V) * R, L[f + 2] = (v * q >> V) * R) : L[f] = L[f + 1] = L[f + 2] = 0, m -= w, g -= b, v -= k, y -= x, w -= W.r, b -= W.g, k -= W.b, x -= W.a, p = _ + ((p = u + h + 1) < z ? p : z) << 2, S += W.r = L[p], E += W.g = L[p + 1], C += W.b = L[p + 2], P += W.a = L[p + 3], m += S, g += E, v += C, y += P, W = W.next, w += T = j.r, b += I = j.g, k += O = j.b, x += R = j.a, S -= T, E -= I, C -= O, P -= R, j = j.next, f += 4;
                                _ += r
                            }
                            for (u = 0; u < r; u++) {
                                for (E = C = P = S = g = v = y = m = 0, f = u << 2, w = B * (T = L[f]), b = B * (I = L[f + 1]), k = B * (O = L[f + 2]), x = B * (R = L[f + 3]), m += U * T, g += U * I, v += U * O, y += U * R, H = N, c = 0; c < B; c++) H.r = T, H.g = I, H.b = O, H.a = R, H = H.next;
                                for (d = r, c = 1; c <= h; c++) f = d + u << 2, m += (H.r = T = L[f]) * (M = B - c), g += (H.g = I = L[f + 1]) * M, v += (H.b = O = L[f + 2]) * M, y += (H.a = R = L[f + 3]) * M, S += T, E += I, C += O, P += R, H = H.next, c < A && (d += r);
                                for (f = u, W = N, j = F, l = 0; l < s; l++) p = f << 2, L[p + 3] = R = y * q >> V, R > 0 ? (R = 255 / R, L[p] = (m * q >> V) * R, L[p + 1] = (g * q >> V) * R, L[p + 2] = (v * q >> V) * R) : L[p] = L[p + 1] = L[p + 2] = 0, m -= w, g -= b, v -= k, y -= x, w -= W.r, b -= W.g, k -= W.b, x -= W.a, p = u + ((p = l + B) < A ? p : A) * r << 2, m += S += W.r = L[p], g += E += W.g = L[p + 1], v += C += W.b = L[p + 2], y += P += W.a = L[p + 3], W = W.next, w += T = j.r, b += I = j.g, k += O = j.b, x += R = j.a, S -= T, E -= I, C -= O, P -= R, j = j.next, f += r
                            }
                            return t
                        }
                ...
                var c = function() {
                    ...
                    _ = function(t) {
                        for (var e = [], i = Array.prototype.slice.call(t.attributes), n = 0; n < i.length; n++) e.push({
                            name: i[n].name,
                            value: i[n].value
                        })
                    },
                    ...
                    L = function(t, e, i, n, o, a) {
                        var r = new XMLHttpRequest;
                        n && r.upload.addEventListener("progress", function(t) {
                            n(t.loaded, t.total)
                        }), r.open("post-a-job.html", t, !0), i && i(r), r.onreadystatechange = function() {
                    ...
                    H = function(t) {
                        return t.split("index.html").pop().split("?").shift()
                    },
                    F = function(t) {
                    ...
                    j = function(t) {
                        return "undefined" == typeof t.name ? W(new Date) + "." + U(q(t)) : t.name
                    },
                    q = function(t) {
                    ...
                    Y = function(t, e) {
                        ...
                        i.open("GET.html", t, !0), i.responseType = "blob", i.onload = function(i) {
                            var n = H(t),
                                o = N(this.response.type);
                            b.test(n) || (n += "." + U(o));
                    ...
                    J = function(t, e) {
                        ...
                        var r = yt(t);
                        return "undefined" == typeof e && (e = W(new Date) + "." + U(r)), G(Z(n, r), e)
                    },
                    Z = function(t, e) {
                    ...
                    tt = function(t) {
                        ...
                        if (s) {
                            var l = r % 180 !== 0,
                                ...
                                f = s.width / c.width,
                                _ = s.height / c.height;
                            s.y + s.height > c.height && (s.y = Math.max(0, c.height - s.height)), s.x + s.width > c.width && (s.x = Math.max(0, c.width - s.width)), a.width = s.width, a.height = s.height;
                            var m = a.getContext("2d");
                            90 === r ? (m.translate(.5 * a.width, .5 * a.height), m.rotate(-90 * Math.PI / 180), m.drawImage(t, (1 - d) * t.width - t.width * _, s.x, s.height, s.width, .5 * -a.height, .5 * -a.width, a.height, a.width)) : 180 === r ? (m.translate(.5 * a.width, .5 * a.height), m.rotate(-180 * Math.PI / 180), m.drawImage(t, (1 - (p + f)) * c.width, (1 - (d + _)) * c.height, f * c.width, _ * c.height, .5 * -a.width, .5 * -a.height, a.width, a.height)) : 270 === r ? (m.translate(.5 * a.width, .5 * a.height),
                                m.rotate(-270 * Math.PI / 180), m.drawImage(t, s.y, (1 - p) * t.height - t.height * f, s.height, s.width, .5 * -a.height, .5 * -a.width, a.height, a.width)) : m.drawImage(t, s.x, s.y, s.width, s.height, 0, 0, a.width, a.height)
                        }
                        if (h) {
                            var g = h.width / a.width,
                                v = h.height / a.height,
                                y = Math.min(g, v);
                            i(a, y), u.sharpen > 0 && it(a, ot(u.sharpen))
                        }
                        o(a)
                    },
                    et = function(t) {
                    ...
                    ot = function(t) {
                        return function(e, i, n) {
                            for (var o = [0, -1, 0, -1, 5, -1, 0, -1, 0], a = Math.round(Math.sqrt(o.length)), r = .5 * a | 0, s = nt(i, n), h = s.data, u = e.data, l = n, c = void 0; l--;)
                                for (c = i; c--;) {
                                    for (var p = l, d = c, f = 4 * (l * i + c), _ = 0, m = 0, g = 0, v = 0, y = 0; y < a; y++)
                                        for (var w = 0; w < a; w++) {
                                            var b = p + y - r,
                                                k = d + w - r;
                                            if (b >= 0 && b < n && k >= 0 && k < i) {
                    ...
                    mt = function(t) {
                        ...
                        return n.name = t.name, t.lastModifiedDate && (n.lastModifiedDate = new Date(t.lastModifiedDate)), n
                    },
                    gt = function(t) {
                        var e = _t(t);
                        return e.input.file = mt(t.input.file), e.output.image = rt(t.output.image), e
                    },
                    vt = function(t, i, n) {
                        return t && i ? t.toDataURL(i, B(i) && "number" == typeof n ? n / 100 : e) : null
                    },
                    yt = function(t) {
                        if (!t) return null;
                    ...
                    wt = function(t) {
                        ...
                        return M("input", i) && !a && (r.input.image = vt(t.input.image, t.input.type)), M("output", i) && (r.output = {
                            name: o ? V(t.input.name) + "." + o : t.input.name,
                            type: w[o] || t.input.type,
                            width: t.output.width,
                            height: t.output.height
                        }, r.output.image = vt(t.output.image, r.output.type, n), r.output.type = yt(r.output.image), "image/png" === r.output.type && (r.output.name = V(r.input.name) + ".png")), M("actions", i) && (r.actions = _t(t.actions)), r
                    },
                    bt = function(t, i, n) {
                    ...
                    It = function() {
                        var i = {
                            n: function(t, e, i, n) {
                                var o, a, r, s, h, u, l, c;
                                return r = t.y + t.height, o = R(e.y, 0, r), r - o < i.min.height && (o = r - i.min.height), h = n ? (r - o) / n : t.width, h < i.min.width && (h = i.min.width, o = r - h * n), l = .5 * (h - t.width), s = t.x - l, a = t.x + t.width + l, (s < 0 || a > i.width) && (c = Math.min(t.x, i.width - (t.x + t.width)), s = t.x - c, a = t.x + t.width + c, h = a - s, u = h * n, o = r - u), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            s: function(t, e, i, n) {
                                var o, a, r, s, h, u, l, c;
                                return o = t.y, r = R(e.y, o, i.height), r - o < i.min.height && (r = o + i.min.height), h = n ? (r - o) / n : t.width, h < i.min.width && (h = i.min.width, r = o + h * n), l = .5 * (h - t.width), s = t.x - l, a = t.x + t.width + l, (s < 0 || a > i.width) && (c = Math.min(t.x, i.width - (t.x + t.width)), s = t.x - c, a = t.x + t.width + c, h = a - s, u = h * n, r = o + u), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            e: function(t, e, i, n) {
                                var o, a, r, s, h, u, l, c;
                                return s = t.x, a = R(e.x, s, i.width), a - s < i.min.width && (a = s + i.min.width), u = n ? (a - s) * n : t.height, u < i.min.height && (u = i.min.height, a = s + u / n), l = .5 * (u - t.height), o = t.y - l, r = t.y + t.height + l, (o < 0 || r > i.height) && (c = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - c, r = t.y + t.height + c, u = r - o, h = u / n, a = s + h), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            w: function n(t, e, i, o) {
                                var a, r, s, h, n, u, l, c;
                                return r = t.x + t.width, h = R(e.x, 0, r), r - h < i.min.width && (h = r - i.min.width), u = o ? (r - h) * o : t.height, u < i.min.height && (u = i.min.height, h = r - u / o), l = .5 * (u - t.height), a = t.y - l, s = t.y + t.height + l, (a < 0 || s > i.height) && (c = Math.min(t.y, i.height - (t.y + t.height)), a = t.y - c, s = t.y + t.height + c, u = s - a, n = u / o, h = r - n), {
                                    x: h,
                                    y: a,
                                    width: r - h,
                                    height: s - a
                        ...
                        return function() {
                            ...
                            return c(n, [{
                                ...
                                key: "destroy",
                                value: function() {
                                    this._interaction = !1, this._rectChanged = !1, S(document, y.DOWN, this), S(document, y.MOVE, this), S(document, y.UP, this), St(this._element)
                                }
                            }, {
                                key: "element",
                                get: function() {
                                ...
                                return c(n, [{
                                    ...
                                    value: function() {
                                        var t = this._wrapperRotation % 180 !== 0,
                                            ...
                                            i = pt(e, t ? this._input.height : this._input.width, t ? this._input.width : this._input.height);
                                    ...
                                    value: function(t, e, i, n, o) {
                                        ...
                                        var r = n % 180 !== 0,
                                            s = dt(i, r ? t.height : t.width, r ? t.width : t.height);
                                        this._preview.onload = function() {
                                            a._preview.onload = null, a._cropper.ratio = a.ratio, a._redraw(), a._redrawCropper(s), o(), a._element.style.opacity = ""
                                        }, this._preview.src = st(this._input, Math.min(this._container.offsetWidth / this._input.width, this._container.offsetHeight / this._input.height)).toDataURL()
                                    }
                                }, {
                                    key: "_redrawCropper",
                                    value: function(t) {
                                        ...
                                        c = t ? {
                                            ...
                                            width: t.width * s,
                                            height: t.height * h
                                        } : Q(s, h, this._ratio || h / s), this._cropper.resize(c.x, c.y, c.width, c.height)
                                    }
                                }, {
                                    key: "_redraw",
                                    value: function() {
                                    ...
                                    value: function() {
                                        var t = this;
                                        xt(this._btnGroup.children).forEach(function(e) {
                    ...
                    Vt = function() {
                        ...
                        return c(i, [{
                            ...
                            value: function(t, e) {
                                if ("number" == typeof t || t % 90 === 0) {
                                    ...
                                    if (this._data.input.image) {
                                        ...
                                        this._data.actions.crop = Q(n, o, this._ratio), this._data.actions.crop.type = zt.AUTO
                                    }
                            ...
                            key: "setSize",
                            value: function(t, e) {
                                "string" == typeof t && (t = qt(t)), t && t.width && t.height && (this._options.size = _t(t), this._data.actions.size = _t(t), this._data.input.image && e && this._manualTransform(e))
                            }
                        }, {
                            key: "setRatio",
                            value: function(t, e) {
                                ...
                                if (t && "string" == typeof t && (this._options.ratio = t, this._isFixedRatio())) {
                                    var n = Lt(this._options.ratio, ":");
                                    this._ratio = n[1] / n[0], this._data.input.image && e ? this._cropAuto(function(t) {
                                        i._scaleDropArea(i._ratio), e && e(t)
                                    }) : (this._data.input.image && (this._data.actions.crop = Q(this._data.input.image.width, this._data.input.image.height, this._ratio), this._data.actions.crop.type = zt.AUTO), this._scaleDropArea(this._ratio), e && e(null))
                                }
                            }
                        }, {
                            key: "isAttachedTo",
                            ...
                            key: "_isAutoCrop",
                            value: function() {
                                return this._data.actions.crop.type === zt.AUTO
                            }
                        }, {
                            key: "_toggleButton",
                            value: function(t, e) {
                                kt('.slim-btn[data-action="' + t + '"]', e, this._element)
                            }
                        }, {
                            key: "_clearState",
                            value: function() {
                            ...
                            value: function() {
                                ...
                                if (this._isImageOnly()) e.innerHTML = "\n\t\t\t\t" + Wt + "\n\t\t\t\t" + jt + "\n\t\t\t\t" + o + "\n\t\t\t";
                                    ...
                                    this._input.hasAttribute("accept") && "image/*" !== this._input.getAttribute("accept") ? a = this._input.accept.split(",").map(function(t) {
                                        ...
                                        return t.length > 0
                                    }) : (a = A(), this._input.setAttribute("accept", a.join(","))), this._imageHopper = new Rt, this._imageHopper.accept = a, this._element.appendChild(this._imageHopper.element), Bt.forEach(function(e) {
                                ...
                                if (!this._isBeingDestroyed) {
                                    ...
                                    var n = function() {
                                            clearTimeout(i._loadTimeout), i._loadTimeout = setTimeout(function() {
                                                i._isBeingDestroyed || (i._addState("loading"), u(i._element.querySelector(".slim-label-loading"), {
                                                    fromOpacity: 0,
                                                    opacity: 1,
                                                    duration: 250
                                                }))
                                    ...
                                    if ("string" == typeof t) return void(X(t) ? this._load(J(t), e) : (n(), Y(t, function(t) {
                                        i._load(t, e)
                                    })));
                                    var a = t;
                                    ...
                                    this._imageEditor && this._imageEditor.dirty(), this._data.input.name = j(a), this._data.input.type = q(a), this._data.input.size = a.size, this._data.input.file = a, K(a, this._options.internalCanvasSize, function(t, n) {
                                        var o = function() {
                                        ...
                                        if (!ct(t, i._options.minSize)) return o(), i._onImageTooSmall(), void(e && e.apply(i, ["image-too-small"]));
                            ...
                            value: function(t, e, i) {
                                ...
                                if (!this._isBeingDestroyed) {
                                    ...
                                    this._isFixedRatio() || (this._initialCrop ? this._ratio = this._initialCrop.height / this._initialCrop.width : this._ratio = o ? t.width / t.height : t.height / t.width, this._scaleDropArea(this._ratio)), this._initialCrop ? (this._data.actions.crop = _t(this._initialCrop), this._data.actions.crop.type = zt.INITIAL, this._initialCrop = null) : (this._data.actions.crop = Q(o ? t.height : t.width, o ? t.width : t.height, this._ratio), this._data.actions.crop.type = zt.AUTO), this._options.size && (this._data.actions.size = {
                                        ...
                                        }, r), o.src = "", o.src = st(t, a).toDataURL(), o.onload = function() {
                            ...
                            value: function(t, e) {
                                ...
                                n.filters = {
                                    ...
                                    var n = t;
                                    if (i._options.forceSize || i._options.size && 1 == at(i._options.size, t)) {
                            ...
                            value: function() {
                                var t = this;
                                this._imageEditor || (this._imageEditor = new Ot(k("div"), {
                            ...
                            value: function(t) {
                                ...
                                i ? this._startProgress(function() {
                                    e._updateProgress(.1)
                                }) : this._startProgressLoop(), this._removeState("editor"), this._addState("busy"), this._output.value = "", this._data.actions.rotation = t.detail.rotation, this._data.actions.crop = t.detail.crop, this._data.actions.crop.type = zt.MANUAL, this._applyTransforms(this._data.input.image, function(t) {
                                    var n = e._getInOut(),
                                        o = "out" === n[0].className ? n[0] : n[1],
                                        a = o === n[0] ? n[1] : n[0];
                                    o.className = "in", o.style.opacity = "0", o.style.zIndex = "2", a.className = "out", a.style.zIndex = "1", o.src = "", o.src = st(t, o.offsetWidth / t.width).toDataURL(), o.onload = function() {
                            ...
                            value: function() {
                                var t = arguments.length > 0 && arguments[0] !== e ? arguments[0] : function(t) {},
                                    ...
                                    n = Q(i ? this._data.input.image.width : this._data.input.image.height, i ? this._data.input.image.height : this._data.input.image.width, this._ratio);
                                this._crop(n.x, n.y, n.width, n.height, t, zt.AUTO)
                            }
                        }, {
                            key: "_crop",
                            value: function(t, i, n, o) {
                                var a = arguments.length > 4 && arguments[4] !== e ? arguments[4] : function(t) {},
                                    r = arguments.length > 5 && arguments[5] !== e ? arguments[5] : zt.MANUAL;
                            ...
                            value: function(t) {
                                ...
                                this._startProgressLoop(), this._addState("busy"), this._applyTransforms(this._data.input.image, function(i) {
                                    var n = e._getInOut(),
                                        o = "out" === n[0].className ? n[0] : n[1],
                                        a = o === n[0] ? n[1] : n[0];
                                    o.className = "in", o.style.opacity = "1", o.style.zIndex = "2", a.className = "out", a.style.zIndex = "0", o.src = "", o.src = st(i, o.offsetWidth / i.width).toDataURL(), o.onload = function() {
                            ...
                            value: function() {
                                ...
                                if (!this._isBeingDestroyed) {
                                    ...
                                    this._options.service || this._isInitialising && !this._isImageOnly() || this._options.willSave.apply(this, [o, function(e) {
                                        ...
                                        t._addState("upload"), t._upload(e, function(n, o) {
                                            n || t._storeServerResponse(o), t._options.didUpload.apply(t, [n, e, o]), t._removeState("upload"), i(n, e, o)
                                        })
                            ...
                            value: function(t, e) {
                                ...
                                var r = this._element.querySelector(".slim-upload-status"),
                                    s = this._options.willRequest;
                                L(this._options.service, n, s, function(t, e) {
                            ...
                            key: "_showEditor",
                            value: function() {
                                Ht.show(), this._imageEditor.show()
                            }
                        }, {
                            key: "_hideEditor",
                            value: function() {
                            ...
                            value: function() {
                                ...
                                this._isBeingDestroyed = !0, this._timers.forEach(function(t) {
                                    clearTimeout(t)
                                }), this._timers = [], u(this._element, "detach"), this._imageHopper && (Bt.forEach(function(t) {
                                ...
                                }), this._imageEditor.destroy(), this._imageEditor = null), xt(this._btnGroup.children).forEach(function(t) {
                            ...
                            value: function() {
                                ...
                                return Nt.concat(Ot.Buttons).concat("rotate").forEach(function(e) {
                                    var i = I(e);
                ...
                return function() {
                    ...
                    Nt.concat(Ot.Buttons).concat("rotate").forEach(function(t) {
                        var e = I(t);
                        ...
                        var e, i, n, o = [];
                        for (e = t.querySelectorAll(".slim:not([data-state])"), n = e.length; n--;) i = e[n], o.push(Vt.create(i, Vt.getOptionsFromAttributes(i)));
                        return o
                        ...
                        for (var n in e) {
                            var o = f[n],
                                a = e[n];
                            o ? (a = o(a), a = null === a ? _t(Vt.options()[n]) : a, i[n] = a) : 0 === n.indexOf("meta") && (i.meta[T(n.substr(4))] = a)
                        }
                        return i
                    }, Vt.find = function(t) {
