jQuery(document).ready(function($) {
	...
	setTimeout(function(){
	   ...
	   // $("#submit-resume-form .jmfe-input-text.input-text.text-date").MonthPicker({ ShowIcon: false,StartYear: 2027});
	    $(".multiselect-main_duties_resume").prop('multiple', 'multiple');
        $(".multiselect-main_duties_resume").data('placeholder', 'Select option');
        $(".multiselect-main_duties_resume").chosen({max_selected_options: 5});
        return false;
